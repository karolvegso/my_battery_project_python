...
path_to_data='d:/programs_work/Python/keithley_6221_elcurrent_source_2182_nanovoltmeter/240624_evaluation/Cu_ITO_LPSCl_Li_04 (4)/Cu_ITO_LPSCl_Li_04/'
...
no_folder_digits=6
# path to save data
path_to_folder_save_data='d:/programs_work/Python/keithley_6221_elcurrent_source_2182_nanovoltmeter/240624_evaluation/Cu_ITO_LPSCl_Li_04_data_stiching/'
# root name for save data
root_name_save_data='240624_Cu_ITO_LPSCl_Li_04_data_stiching'
...
for index_1 in range(no_meas):
    buffer_reshaped[index_1][0]=float((index_1*time_constant)/3600)
